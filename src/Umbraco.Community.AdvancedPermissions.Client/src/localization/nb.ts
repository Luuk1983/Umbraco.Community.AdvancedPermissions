...
export default {
  uap: {
    ...
    help_libraryPermissions_description: 'Administrer Tillat/Nekt-tillatelser per brukergruppe på tvers av Library-treet.',
    help_elementTypePermissions_description: 'Styr hvilke elementtyper hver brukergruppe kan bruke i Library.',
    help_libraryAccessViewer_description: 'Se de effektive Library-tillatelsene en bruker eller brukergruppe har på hver node.',
    help_libraryInsertViewer_description: 'Revider hvilke elementtyper en bruker eller brukergruppe kan sette inn i Library.',
    ...
    previewElementFolderSet: (action: string) => `Gjelder ikke for denne mappen. ${action} for elementene inni den.`,
    previewElementFolderInherit: 'Gjelder ikke for denne mappen. Elementene inni den arver fra sin overordnede node.',
    dialogElementFolderNote: (verb: string) => `“${verb}” gjelder ikke for en mappe — kun for elementene inni den.`,
    ...
    library_accessViewerHeadline: 'Tilgangsvisning for Library',
    library_nodeHeader: 'Library-element',
    library_root: 'Standardtillatelser',
    library_selectRolePrompt: 'Velg en brukergruppe for å administrere dens Library-tillatelser.',
    library_permissionsSaved: 'Library-tillatelser lagret.',
    ...
    elementTypePermissions_noTypes: 'Ingen Library-elementtyper funnet. Merk en dokumenttype som en elementtype og aktiver “Tillat i Library”.',
    elementType_dialogHeadline: (type: string) => `Opprett-tillatelse for ‘${type}’ i Library`,
    elementType_inheritLabel: 'Ikke angitt (tillatt som standard)',
    elementType_allowLabel: 'Tillat (kan opprettes i Library)',
    elementType_denyLabel: 'Nekt (skjult fra Library)',
    elementType_previewInherit: 'Ingen eksplisitt regel. Denne elementtypen kan opprettes i Library som standard.',
    elementType_previewSet: (action: string) => `${action} oppretting av denne elementtypen i Library.`,
  },
