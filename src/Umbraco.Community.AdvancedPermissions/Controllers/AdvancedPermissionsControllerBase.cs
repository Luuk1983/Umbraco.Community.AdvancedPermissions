...
/// even the element current-user endpoint (used to gate library editing) behind the Users section and
/// left library content read-only for users without that section. See the individual controllers for
/// where the section gate is applied.
/// </remarks>
