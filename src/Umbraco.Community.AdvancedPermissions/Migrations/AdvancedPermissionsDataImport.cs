    ...
    : INotificationAsyncHandler<UmbracoApplicationStartingNotification>
{
    ...
    private List<AdvancedPermissionEntity> ComputeGroupEntries(IUserGroup group)
    {
        ...
        // also include verbs outside our node-level model (e.g. Umbraco 18's Umb.Document.PropertyValue.*
        // and Umb.Element.*), which we neither resolve nor display — importing one would store a row the
        // editor later re-sends and the save endpoint rejects. Those permissions stay natively managed.
