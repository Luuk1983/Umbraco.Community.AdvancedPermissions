...
export default {
  uas: {
    ...
    redirectMessage:
      'Documentmachtigingen voor deze gebruikersgroep worden beheerd door het Advanced Security-pakket. Open de Beveiligingseditor in de sectie Gebruikers om machtigingen te configureren.',
  },
