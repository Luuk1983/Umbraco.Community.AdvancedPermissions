...
/// Whether this entry is a priority override (CSS <c>!important</c>-style escape hatch for
/// cross-role Explicit Deny). Defaults to <see langword="false"/>; older clients that omit the
/// field continue to save non-override entries unchanged.
/// </param>
