...
export default {
  uap: {
    ...
    help_libraryPermissions_description: 'Керуйте правами «Дозволити»/«Заборонити» для кожної групи користувачів у дереві Library.',
    help_elementTypePermissions_description: 'Керуйте тим, які типи елементів кожна група користувачів може використовувати в Library.',
    help_libraryAccessViewer_description: 'Перегляньте дійсні права доступу до Library, які користувач або група користувачів має на кожному вузлі.',
    help_libraryInsertViewer_description: 'Перевірте, які типи елементів користувач або група користувачів може вставляти в Library.',
    ...
    previewElementFolderSet: (action: string) => `Не застосовується до цієї теки. ${action} для елементів усередині неї.`,
    previewElementFolderInherit: 'Не застосовується до цієї теки. Елементи всередині неї успадковують від свого батьківського вузла.',
    dialogElementFolderNote: (verb: string) => `«${verb}» не застосовується до теки — лише до елементів усередині неї.`,
    elementFolderDescSection: 'Елементи всередині',
    naChip: 'Н/Д',
    redirectMessageElement:
      'Права доступу до Library (елементів) для цієї групи користувачів керуються пакетом Advanced Permissions. Відкрийте Редактор прав доступу Library в розділі Користувачі, щоб налаштувати права доступу.',
    library_menuLabel: 'Редактор прав доступу Library',
    library_editorHeadline: 'Редактор прав доступу Library',
    library_accessViewerMenuLabel: 'Перегляд доступу Library',
    library_accessViewerHeadline: 'Перегляд доступу Library',
    library_nodeHeader: 'Елемент Library',
    library_root: 'Права доступу за замовчуванням',
    library_selectRolePrompt: 'Виберіть групу користувачів, щоб керувати її правами доступу до Library.',
    library_permissionsSaved: 'Права доступу Library збережено.',
    ...
    elementTypePermissions_noTypes: 'Типів елементів Library не знайдено. Позначте тип документа як тип елемента та ввімкніть «Дозволити в Library».',
    elementType_dialogHeadline: (type: string) => `Право створення для ‘${type}’ у Library`,
    elementType_inheritLabel: 'Не задано (дозволено за замовчуванням)',
    elementType_allowLabel: 'Дозволити (можна створювати в Library)',
    elementType_denyLabel: 'Заборонити (приховано з Library)',
    elementType_previewInherit: 'Немає явного правила. Цей тип елемента можна створювати в Library за замовчуванням.',
    elementType_previewSet: (action: string) => `${action} створення цього типу елемента в Library.`,
  },
