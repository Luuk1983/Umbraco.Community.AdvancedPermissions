...
namespace UmbracoAdvancedSecurity.Migrations;
...
/// </para>
/// </remarks>
public sealed class AdvancedSecurityDataImport(
    AdvancedSecurityDbContext dbContext,
    IUserGroupService userGroupService,
    IMainDom mainDom,
    IServerRoleAccessor serverRoleAccessor,
    ILogger<AdvancedSecurityDataImport> logger)
    : INotificationAsyncHandler<UmbracoApplicationStartingNotification>
{
        ...
        CancellationToken cancellationToken)
    {
        ...
        {
            logger.LogDebug("Advanced Security: Skipping data import — not the main domain instance");
            return;
        }
        ...
        {
            logger.LogDebug("Advanced Security: Skipping data import — subscriber instance");
            return;
        }
        ...
        logger.LogInformation("Advanced Security: Permission table is empty — importing from native Umbraco settings");
        ...
        catch (Exception ex)
        {
            ...
            logger.LogWarning(
                ex,
                "Advanced Security: Failed to import native permissions. " +
    ...
    private async Task ImportAsync(CancellationToken cancellationToken)
    {
        ...
        {
            NodeKey = null,
            RoleAlias = AdvancedSecurityConstants.EveryoneRoleAlias,
            Verb = AdvancedSecurityConstants.VerbRead,
        ...
        logger.LogInformation(
            "Advanced Security: Imported {Count} permission entries from native Umbraco settings",
            entries.Count);
    }
