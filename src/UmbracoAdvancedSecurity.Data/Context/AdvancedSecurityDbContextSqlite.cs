...
/// <code>
/// dotnet ef migrations add &lt;MigrationName&gt; --context AdvancedSecurityDbContextSqlite --output-dir Migrations/Sqlite
/// </code>
/// </example>
public sealed class AdvancedSecurityDbContextSqlite : AdvancedSecurityDbContext
{
    /// <summary>
    /// Initializes a new instance with SQLite-specific options.
    /// </summary>
    /// <param name="options">The SQLite-configured DbContext options.</param>
    public AdvancedSecurityDbContextSqlite(DbContextOptions<AdvancedSecurityDbContextSqlite> options)
        : base(options)
    {
    }
